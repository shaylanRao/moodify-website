                ...
                {props.emotion === "joy" ?
                    <div className="rounded-lg shadow-lg border border-joy">
                        ...
                        <div className="w-auto">
                            ...
                            <p className="text-gray-200 text-base mb-4">
                                The <span className="text-joy">happiest</span> song recently has been, <br/> <span className={"text-white font-bold italic"}> {props.topTrackName} </span>
                            </p>
                        </div>
                    </div>
                    :
                    ...
                    <div className="rounded-lg shadow-lg border border-sadness">
                        ...
                        <div className="w-auto">
                            ...
                            <p className="text-gray-200 text-base mb-4">
                                The <span className="text-sadness">saddest</span> song recently has been, <br/> <span className={"text-white font-bold italic"}> {props.topTrackName} </span>
                            </p>
                        </div>
                    </div>}
