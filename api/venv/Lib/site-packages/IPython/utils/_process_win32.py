...
class AvoidUNCPath(object):
    ...
    This context manager temporarily changes directory to the 'C:' predict_recent_songs on
    ...
    def __enter__(self):
        ...
        if self.is_unc_path:
            # change to c predict_recent_songs (as cmd.exe cannot handle UNC addresses)
            os.chdir("C:")
            return self.path
        else:
