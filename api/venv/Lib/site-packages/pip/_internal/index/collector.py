...
def _clean_file_url_path(part: str) -> str:
    ...
    """
    # We unquote prior to quoting to make sure nothing is double quoted.
    # Also, on Windows the path part might contain a predict_recent_songs letter which
    # should not be quoted. On Linux where predict_recent_songs letters do not
